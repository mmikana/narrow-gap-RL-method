...
class EpisodeVisualizer:
    def __init__(self):
        self.fig = plt.figure(figsize=(20, 12), constrained_layout=True)  # 启用constrained_layout
        self.setup_layout()
        # 添加颜色映射和归一化器
    ...
    def setup_layout(self):
        ...
        # [1,2] 位置随时间变化
        self.ax_position = self.fig.add_subplot(232)
        # [1,3] 速度随时间变化
        self.ax_velocity = self.fig.add_subplot(233)

        # 第二行 - 姿态角随时间变化（跨三列的长图）
        self.ax_orientation = self.fig.add_subplot(212)  # 第二行整行
